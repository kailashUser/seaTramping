...
PORT_CHARGES = {
    ...
    # ── CHINA PORTS ───────────────────────────────────────────────────────────
    'Shanghai':                    {'nav': 22000, 'cong_mean': 1.5, 'cong_std': 0.8},
    'Lianyungang':                 {'nav': 18000, 'cong_mean': 1.0, 'cong_std': 0.5},
    'Meizhou':                     {'nav': 16000, 'cong_mean': 1.0, 'cong_std': 0.5},
    'Qinzhou':                     {'nav': 16000, 'cong_mean': 1.0, 'cong_std': 0.5},
    'Rizhao':                      {'nav': 18000, 'cong_mean': 1.0, 'cong_std': 0.5},
    'Machong':                     {'nav': 16000, 'cong_mean': 1.5, 'cong_std': 0.8},
    'Saiqi':                       {'nav': 15000, 'cong_mean': 1.0, 'cong_std': 0.5},
    'Yangjiang':                   {'nav': 16000, 'cong_mean': 1.0, 'cong_std': 0.5},
    'Tieshan':                     {'nav': 16000, 'cong_mean': 1.0, 'cong_std': 0.5},
    'Lanshan':                     {'nav': 17000, 'cong_mean': 1.0, 'cong_std': 0.5},
    'Nantong':                     {'nav': 16000, 'cong_mean': 1.5, 'cong_std': 0.8},
    'Taicang':                     {'nav': 16000, 'cong_mean': 1.5, 'cong_std': 0.8},
    'Nanjing':                     {'nav': 18000, 'cong_mean': 2.0, 'cong_std': 1.0},
    'Chaozhou':                    {'nav': 15000, 'cong_mean': 1.0, 'cong_std': 0.5},
    'Haimen (Guangdong Province)': {'nav': 15000, 'cong_mean': 1.0, 'cong_std': 0.5},
    'Yuhuan':                      {'nav': 15000, 'cong_mean': 1.0, 'cong_std': 0.5},
    'Xiamen':                      {'nav': 17000, 'cong_mean': 1.0, 'cong_std': 0.5},
    'Gaolan':                      {'nav': 16000, 'cong_mean': 1.0, 'cong_std': 0.5},
    'Shanwei':                     {'nav': 15000, 'cong_mean': 1.0, 'cong_std': 0.5},
    'Fangcheng':                   {'nav': 16000, 'cong_mean': 1.0, 'cong_std': 0.5},
    'Luoyuanwan':                  {'nav': 15000, 'cong_mean': 1.0, 'cong_std': 0.5},
    'Guangzhou':                   {'nav': 20000, 'cong_mean': 2.0, 'cong_std': 1.0},
    'Zhanjiang':                   {'nav': 16000, 'cong_mean': 1.0, 'cong_std': 0.5},
    'Yangpu (Hainan)':             {'nav': 16000, 'cong_mean': 1.0, 'cong_std': 0.5},
    'Ningde':                      {'nav': 15000, 'cong_mean': 1.0, 'cong_std': 0.5},
    'Kemen':                       {'nav': 15000, 'cong_mean': 1.0, 'cong_std': 0.5},
    'Caofeidian':                  {'nav': 18000, 'cong_mean': 1.5, 'cong_std': 0.8},
    'Weifang':                     {'nav': 16000, 'cong_mean': 1.5, 'cong_std': 0.8},
    'Changzhou':                   {'nav': 16000, 'cong_mean': 1.5, 'cong_std': 0.8},
    'Jinzhou':                     {'nav': 16000, 'cong_mean': 1.5, 'cong_std': 0.8},
    'Jiazi':                       {'nav': 14000, 'cong_mean': 1.0, 'cong_std': 0.5},
    'Bayuquan':                    {'nav': 16000, 'cong_mean': 1.5, 'cong_std': 0.8},
    'Zhenjiang':                   {'nav': 16000, 'cong_mean': 1.5, 'cong_std': 0.8},
    'Ningbo (incl Zhoushan)':      {'nav': 20000, 'cong_mean': 1.5, 'cong_std': 0.8},
    'Huanghua':                    {'nav': 17000, 'cong_mean': 1.5, 'cong_std': 0.8},
    'Dalian':                      {'nav': 18000, 'cong_mean': 1.5, 'cong_std': 0.8},
    'Fuzhou (incl Fuqing)':        {'nav': 17000, 'cong_mean': 1.0, 'cong_std': 0.5},
    'Huizhou':                     {'nav': 15000, 'cong_mean': 1.0, 'cong_std': 0.5},
    'Zhangjiagang':                {'nav': 16000, 'cong_mean': 1.5, 'cong_std': 0.8},
    'Dongguan':                    {'nav': 15000, 'cong_mean': 1.5, 'cong_std': 0.8},

    # ── JAPAN PORTS ───────────────────────────────────────────────────────────
    'Tachibana':                   {'nav': 20000, 'cong_mean': 0.5, 'cong_std': 0.3},
    'Hekinan':                     {'nav': 19000, 'cong_mean': 0.5, 'cong_std': 0.3},
    'Kawanoe (Iyomishima)':        {'nav': 18000, 'cong_mean': 0.5, 'cong_std': 0.3},
    'Toyama':                      {'nav': 18000, 'cong_mean': 0.5, 'cong_std': 0.3},
    'Sakaiminato':                 {'nav': 17000, 'cong_mean': 0.5, 'cong_std': 0.3},
    'Hachinohe':                   {'nav': 18000, 'cong_mean': 0.5, 'cong_std': 0.3},
    'Kobe':                        {'nav': 22000, 'cong_mean': 0.5, 'cong_std': 0.3},
    'Tokuyama':                    {'nav': 19000, 'cong_mean': 0.5, 'cong_std': 0.3},
    'Matsuura':                    {'nav': 19000, 'cong_mean': 0.5, 'cong_std': 0.3},
    'Tonda':                       {'nav': 18000, 'cong_mean': 0.5, 'cong_std': 0.3},
    'Nagoya':                      {'nav': 22000, 'cong_mean': 0.5, 'cong_std': 0.3},
    'Yokohama':                    {'nav': 24000, 'cong_mean': 0.5, 'cong_std': 0.3},
    'Osaka':                       {'nav': 22000, 'cong_mean': 0.5, 'cong_std': 0.3},
    'Kashima':                     {'nav': 20000, 'cong_mean': 0.5, 'cong_std': 0.3},
    'Ishinomaki':                  {'nav': 18000, 'cong_mean': 0.5, 'cong_std': 0.3},

    # ── KOREA PORTS ───────────────────────────────────────────────────────────
    'Kwangyang':                   {'nav': 20000, 'cong_mean': 0.5, 'cong_std': 0.3},
    'Dangjin':                     {'nav': 18000, 'cong_mean': 0.5, 'cong_std': 0.3},
    'Hosan':                       {'nav': 17000, 'cong_mean': 0.5, 'cong_std': 0.3},
    'Samcheon Po':                 {'nav': 17000, 'cong_mean': 0.5, 'cong_std': 0.3},
    'Incheon':                     {'nav': 20000, 'cong_mean': 1.0, 'cong_std': 0.5},
    'Boryeong':                    {'nav': 17000, 'cong_mean': 0.5, 'cong_std': 0.3},
    'Daesan':                      {'nav': 18000, 'cong_mean': 0.5, 'cong_std': 0.3},
    'Gunsan':                      {'nav': 17000, 'cong_mean': 0.5, 'cong_std': 0.3},
    'Ulsan':                       {'nav': 20000, 'cong_mean': 0.5, 'cong_std': 0.3},
    'Pyeongtaek':                  {'nav': 18000, 'cong_mean': 0.5, 'cong_std': 0.3},

    # ── TAIWAN & HONG KONG ────────────────────────────────────────────────────
    'Taichung':                    {'nav': 20000, 'cong_mean': 0.5, 'cong_std': 0.3},
    'Kaohsiung':                   {'nav': 22000, 'cong_mean': 0.5, 'cong_std': 0.3},
    'Lingkou':                     {'nav': 19000, 'cong_mean': 0.5, 'cong_std': 0.3},
    'Ho Ping':                     {'nav': 18000, 'cong_mean': 0.5, 'cong_std': 0.3},
    'Hong Kong':                   {'nav': 24000, 'cong_mean': 0.5, 'cong_std': 0.3},
}
...
PORT_CHARGES_DEFAULT = {
    ...
    'China':                       {'nav': 17000, 'cong_mean': 1.0,  'cong_std': 0.5},
    'Japan':                       {'nav': 20000, 'cong_mean': 0.5,  'cong_std': 0.3},
    'Korea South':                 {'nav': 18000, 'cong_mean': 0.5,  'cong_std': 0.3},
    'Hong Kong':                   {'nav': 24000, 'cong_mean': 0.5,  'cong_std': 0.3},
    'Taiwan, Province of China':   {'nav': 20000, 'cong_mean': 0.5,  'cong_std': 0.3},
